...
(function (global, factory) {
      ...
      value: function init() {
        return {
          ...
          tooltip: {
            ...
            intersect: false,
            // when enabled, tooltip will only show when Users directly hovers over point
            inverseOrder: false,
            custom: undefined,
  ...
  function () {
    ...
    _createClass(CoreUtils, [{
      ...
      value: function checkComboSeries(series) {
        ...
        var comboChartsHasBars = false; // if Users specified a type in series too, turn on comboCharts flag
  ...
  function () {
    ...
    _createClass(Config, [{
      ...
      value: function init() {
        ...
        var mergedWithDefaultConfig = Utils.extend(newDefaults, window.Apex); // get the merged config and extend with Users defined config
      ...
      value: function handleUserInputErrors(opts) {
        ...
        } // if Users supplied array for stroke width, it will only be applicable to line/area charts, for any other charts, revert back to Number
    ...
    _createClass(Globals, [{
      ...
      value: function globalVars(config) {
        return {
          ...
          isDirty: false,
          // chart has been updated after the initial render. This is different than dataChanged property. isDirty means Users manually called some method to update
          initialConfig: null,
          // we will store the first config Users has set to go back when Users finishes interactions like zooming and come out of it
          lastXAxis: [],
          lastYAxis: [],
          series: [],
          ...
          // if Users didn't provide any categories/labels or x values, fallback to 1,2,3,4...
          allSeriesCollapsed: false,
          collapsedSeries: [],
          // when Users collapses a series, it goes into this array
          collapsedSeriesIndices: [],
          // this stores the index of the collapsedSeries instead of whole object for quick access
          ancillaryCollapsedSeries: [],
          // when Users collapses an "alwaysVisible" series, it goes into this array
          ancillaryCollapsedSeriesIndices: [],
          // this stores the index of the collapsedSeries whose y-axis is always visible
          risingSeries: [],
          // when Users re-opens a collapsed series, it goes here
          selectedDataPoints: [],
          ignoreYAxisIndexes: [],
          ...
          zoomed: false,
          // whether Users has zoomed or not
          gridWidth: 0,
        ...
        if (p.x instanceof Array) {
          var _loop = function _loop(q) {
            ...
            if (shouldMarkerDraw) {
              ...
              var opts = _this.getMarkerConfig(PointClasses, seriesIndex); // discrete markers is an option where Users can specify a particular marker with different size and color
  ...
  function () {
    ...
    _createClass(Bar, [{
      ...
      value: function initVariables(series) {
        ...
        this.seriesLen = 0;
        this.visibleI = -1;
        this.visibleItems = 1; // number of visible bars after Users zoomed in/out
  ...
  function (_Bar) {
    ...
    _createClass(BarStacked, [{
      ...
      /*
       * When Users clicks on legends, the collapsed series will be filled with [0,0,0,...,0]
    ...
    _createClass(YAxis, [{
      ...
      value: function setYAxisTextAlignments() {
        ...
        yaxis.forEach(function (y, index) {
          var yaxe = w.config.yaxis[index]; // proceed only if Users has specified alignment
  ...
  function () {
    ...
    _createClass(Dimensions, [{
      ...
      value: function plotCoords() {
        ...
        this.titleSubtitleOffset(); // after calculating everything, apply padding set by Users
      ...
      value: function getyAxisLabelsCoords() {
        ...
        w.config.yaxis.map(function (yaxe, index) {
          if (yaxe.show && yaxe.labels.show && w.globals.yAxisScale[index].result.length) {
            var lbFormatter = w.globals.yLabelFormatters[index]; // the second parameter -1 is the index of tick which Users can use in the formatter

            var val = lbFormatter(w.globals.yAxisScale[index].niceMax, -1); // if Users has specified a custom formatter, and the result is null or empty, we need to discard the formatter and take the value as it is.
  ...
  function () {
    ...
    _createClass(Core, [{
      ...
      value: function handleExternalLabelsData(ser) {
        var cnf = this.w.config;
        var gl = this.w.globals; // Users provided labels in category axis
        ...
        if (cnf.xaxis.categories.length > 0) {
          ...
          // Users didn't provided labels, fallback to 1-2-3-4-5
          var labelArr = [];
      ...
      value: function parseData(ser) {
        ...
        this.coreUtils.getLargestSeries(); // set Null values to 0 in all series when Users hides/shows some series
        ...
        this.coreUtils.getPercentSeries(); // Users didn't provide a [[x,y],[x,y]] series, but a named series
        ...
        if (w.globals.axisCharts || w.config.chart.type === 'radialBar') {
          ...
          if (isHidden) {
            ...
            if (w.globals.axisCharts) {
              ...
              } // TODO: AVOID mutating the Users's config object below
  ...
  function () {
    ...
    _createClass(Theme, [{
      ...
      value: function setDefaultColors() {
        ...
        var defaultColors = w.globals.colors.slice(); // if Users specfied less colors than no. of series, push the same colors again
  ...
  function () {
    ...
    _createClass(Tooltip, [{
      ...
      value: function seriesHover(opt, e) {
        ...
        var chartGroups = [];
        var w = this.w; // if Users has more than one charts in group, we need to sync
    ...
    _createClass(ZoomPanSelection, [{
      ...
      value: function selectionDrawing(_ref3) {
        ...
        if (Math.abs(selectionWidth + startX) > w.globals.gridWidth || me.clientX - gridRectDim.left < 0) {
          // Users dragged the mouse outside drawing area
      ...
      value: function selectionDrawn(_ref4) {
        ...
        if (me.dragged && (me.dragX > 10 || me.dragY > 10) && xLowestValue !== xHighestValue) {
          if (w.globals.zoomEnabled) {
            var yaxis = Utils.clone(w.config.yaxis); // before zooming in/out, store the last yaxis and xaxis range, so that when Users hits the RESET button, we get the original range
            // also - make sure Users is not already zoomed in/out - otherwise we will store zoomed values in lastAxis
        ...
        step: function step(ignoreTime) {
          ...
          if (this.pos == 1 && !this.situation.reversed || this.situation.reversed && this.pos == 0) {
            ...
            if (!this.situations.length) {
              this.target().fire('allfinished'); // Recheck the length since the Users may call animate in the afterAll callback
    ...
    SVG.Set = SVG.invent({
      ...
      extend: {
        ...
        bbox: function bbox() {
          ...
          this.each(function () {
            // Users rbox for correct position and visual representation
  ...
  (function() {
    ...
    SVG.Filter = SVG.invent({
      ...
      extend: {
        ...
        // Merge effect
        merge: function() {
          //pass the array of arguments to the constructor because we dont know if the Users gave us an array as the first arguemnt or wether they listed the effects in the arguments
          var args = [undefined];
  ...
  * Copyright (c) 2016 Wout Fierens; Licensed MIT */
  (function() {
    ...
    // transforms one point from screen to Users coords
  ...
  **/
  ...
  function () {
    function ApexCharts(el, opts) {
      ...
      this.opts = opts;
      this.ctx = this; // Pass the Users supplied options to the Base Class where these options will be extended with defaults. The returned object from Base Class will become the config object in the entire codebase.
    ...
    _createClass(ApexCharts, [{
        ...
        charts.forEach(function (ch) {
          ...
          if (options$$1 && _typeof(options$$1) === 'object') {
            ...
            if (overwriteInitialConfig) {
              // we need to forget the lastXAxis and lastYAxis is Users forcefully overwriteInitialConfig. If we do not do this, and next time when Users zooms the chart after setting yaxis.min/max or xaxis.min/max - the stored lastXAxis will never allow the chart to use the updated min/max by Users.
              w.globals.lastXAxis = [];
      ...
      value: function _updateSeries(newSeries, animate) {
        ...
        w.globals.dataChanged = true; // if Users has collapsed some series with legend, we need to clear those
      ...
      value: function revertDefaultAxisMinMax() {
        ...
        w.config.yaxis.map(function (yaxe, index) {
          if (w.globals.zoomed) {
            // if Users has zoomed, and this function is called
      ...
      value: function setCurrentLocaleValues(localeName) {
        var locales = this.w.config.chart.locales; // check if Users has specified locales in global Apex variable
       ...
       * instance of the chart in case Users has assigned chartID to the targetted chart.
